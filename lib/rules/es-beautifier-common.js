...
const findOpeningBrace = (sourceCode, childrenName) =>
  node => findPunctuator('{', getFirstChild(childrenName)(node), sourceCode.getTokenBefore);

const findClosingBrace = (sourceCode, childrenName) =>
  node => findPunctuator('}', getLastChild(childrenName)(node), sourceCode.getTokenAfter);
