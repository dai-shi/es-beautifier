...
const findOpeningBrace = (sourceCode, childrenName) =>
  node => findPunctuator('{', getFirstChild(childrenName)(node), sourceCode.getTokenBefore.bind(sourceCode));

const findClosingBrace = (sourceCode, childrenName) =>
  node => findPunctuator('}', getLastChild(childrenName)(node), sourceCode.getTokenAfter.bind(sourceCode));
